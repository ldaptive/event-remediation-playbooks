 ...
 * Created: 2021-05-12
 * Description: Removes AMI's older than 3 months that are not in use
 * Compliance Frameworks: Cost Savings & compliance
 * -----------------------  AWS Event Details  ---------------------------
 * eventSource: N/A
 * eventName: N/A
 * =======================================================================
...
module.exports.run = (event) => new Promise(async (resolve) => {
    ...
    var url = `api/ami/images/${event.accountDetails.accountId}?RecordStatus=Active&InUse=false&CreationDate[lt]=2021-01-01&fields=accountId,Name,ImageId,Region,InUse,CreationDate,Platform,Description`;
